...
// TypeX vendor addition, see header.
- (NSString *)selectedApplicationID
{
	return _selectedApplicationID;
}

- (void)setSelectedApplicationID:(NSString *)selectedApplicationID
{
	_selectedApplicationID = [selectedApplicationID copy];
}
